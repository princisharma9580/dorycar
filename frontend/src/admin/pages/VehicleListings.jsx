...
const VehicleListings = () => {
  return (
    <div className="px-8 py-6">
      ...
      <p className="text-gray-500 mb-6">Manage your fleet and vehicle availability</p>
      ...
      <div className="flex justify-center items-center gap-4 text-gray-500 mt-6">
        <button className="text-sm px-3 py-1 rounded border border-gray-300">Previous</button>
        <span className="text-sm">Page 1 of 1</span>
        <button className="text-sm px-3 py-1 rounded border border-gray-300">Next</button>
      </div>
    </div>
  );
};
